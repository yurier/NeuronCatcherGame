...
pygame.init()
pygame.mixer.init()
beep_sound1 = pygame.mixer.Sound('/home/yurier/neuroncatcher_outreach/sounds/button2.ogg')  # Make sure you have a beep sound file
beep_sound2 = pygame.mixer.Sound('/home/yurier/neuroncatcher_outreach/sounds/button1.ogg')  # Make sure you have a beep sound file


warnings.filterwarnings("ignore")

def start_other_script():
    subprocess.Popen(["ipython", "game_neuron9.py"], cwd="/home/yurier/neuroncatcher_outreach")
    ...
    while len(data_buffer) >= CHUNKSZ * 2:
        ...
        if samples:
            ...
            if higher_activated_now and current_time - last_higher_activation > time_sensitivity:
                ...
                beep_sound1.play()  # Play beep sound for right trigger
            if lower_activated_now and current_time - last_lower_activation > time_sensitivity:
                ...
                beep_sound2.play()  # Play beep sound for right trigger
